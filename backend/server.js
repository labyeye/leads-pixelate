...
app.use("/api/price-books", inventory.priceBooks);
app.use("/api/sales-orders", inventory.salesOrders);
app.use("/api/purchase-orders", inventory.purchaseOrders);
app.use("/api/invoices", inventory.invoices);
