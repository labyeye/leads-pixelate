...
> = {
  starter: {
    ...
    features: [
      ...
      "Social Autopilot: 1 post/week (~4 posts/mo), 1 campaign",
  ...
  growth: {
    ...
    features: [
      ...
      "Social Autopilot: 3 posts/week (~13 posts/mo), 3 campaigns",
  ...
  professional: {
    ...
    features: [
      ...
      "Social Autopilot: 5 posts/week (~22 posts/mo), 5 campaigns",
      "All integrations",
      "Advanced analytics",
      "Custom workflows",
      "Dedicated support",
