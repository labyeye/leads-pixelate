...
const styles = StyleSheet.create({
  ...
  stepNum: {fontSize: 11, fontWeight: '600', color: '#94a3b8'},
  stepLabel: {fontSize: 9, fontWeight: '700', color: '#94a3b8', textTransform: 'uppercase'},

  scroll: {flex: 1},
  stepBody: {padding: 16, gap: 8},

  label: {fontSize: 10, fontWeight: '600', color: '#64748b', textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 4},
  ...
  typeBtnText: {fontSize: 10, fontWeight: '600', color: '#64748b'},
  ...
  dtTitle: {fontSize: 12, fontWeight: '600', color: '#000', textAlign: 'center', marginBottom: 16, letterSpacing: 1},
  dtRow: {flexDirection: 'row', justifyContent: 'space-around', gap: 12},
  dtCol: {alignItems: 'center', gap: 4, flex: 1},
  dtArrow: {padding: 6},
  dtVal: {fontSize: 22, fontWeight: '600', color: '#000', minWidth: 50, textAlign: 'center'},
  dtFieldLabel: {fontSize: 9, fontWeight: '600', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: 1},
  ...
  reviewLabel: {fontSize: 9, fontWeight: '600', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 3},
  ...
  prevBtnText: {fontSize: 13, fontWeight: '600', color: '#000'},
  ...
  draftBtnText: {fontSize: 11, fontWeight: '600', color: '#000'},
