...
const styles = StyleSheet.create({
  ...
  type: {fontSize: 10, fontWeight: '900', color: '#64748b', textTransform: 'uppercase', letterSpacing: 1},
  ...
  btnText: {fontSize: 11, fontWeight: '900', color: '#000', textTransform: 'uppercase'},
});
