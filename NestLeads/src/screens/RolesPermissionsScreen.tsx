...
const s = StyleSheet.create({
  ...
  tabText: {fontSize: 12, fontWeight: '600', textTransform: 'uppercase', color: '#000'},
  ...
  roleName: {fontSize: 15, fontWeight: '600', color: '#000'},
  tags: {flexDirection: 'row', gap: 6, marginTop: 6},
  tag: {borderWidth: 2, borderColor: '#024BAB', paddingHorizontal: 8, paddingVertical: 1},
  tagText: {fontSize: 10, fontWeight: '600', color: '#024BAB', textTransform: 'uppercase'},
  ...
  pillText: {fontSize: 11, fontWeight: '600', textTransform: 'uppercase', color: '#000'},
  ...
  matrixHeadText: {fontSize: 11, fontWeight: '600', textTransform: 'uppercase', color: '#000'},
  opHead: {width: 40, textAlign: 'center', fontSize: 11, fontWeight: '600', color: '#000'},
  ...
  saveText: {color: '#fff', fontSize: 13, fontWeight: '600', textTransform: 'uppercase'},
  backdrop: {flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', padding: 24},
  dialog: {backgroundColor: '#fff', borderWidth: 2, borderColor: '#000', padding: 16},
  dialogTitle: {fontSize: 16, fontWeight: '600', color: '#000', marginBottom: 10},
  ...
  dialogBtnText: {color: '#fff', fontSize: 12, fontWeight: '600', textTransform: 'uppercase'},
});
