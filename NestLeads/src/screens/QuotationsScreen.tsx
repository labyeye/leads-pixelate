...
const styles = StyleSheet.create({
  ...
  summaryChipText: {fontSize: 9, fontWeight: '600', textTransform: 'uppercase'},
  ...
  cardInfo: {flex: 1},
  projectTitle: {fontSize: 14, fontWeight: '600', color: '#000'},
  ...
  totalText: {fontSize: 14, fontWeight: '600', color: '#000'},
