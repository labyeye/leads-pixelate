...
const s = StyleSheet.create({
  ...
  section: {fontSize: 12, fontWeight: '600', color: '#000', textTransform: 'uppercase', marginTop: 16, marginBottom: 8},
  ...
  itemNo: {fontSize: 11, fontWeight: '600', color: '#64748b', textTransform: 'uppercase'},
  ...
  statusText: {fontSize: 10, fontWeight: '600', textTransform: 'uppercase', color: '#000'},
  ...
  grandLabel: {fontSize: 14, fontWeight: '600', color: '#000'},
  grandValue: {fontSize: 16, fontWeight: '600', color: '#000'},
