...
const styles = StyleSheet.create({
  ...
  planName: {fontSize: 15, fontWeight: '600', color: '#fff'},
  ...
  statValue: {fontSize: 20, fontWeight: '600', color: '#000'},
  statLabel: {fontSize: 10, color: '#64748b', fontWeight: '700', textTransform: 'uppercase'},
  sectionTitle: {fontSize: 15, fontWeight: '600', color: '#000', marginTop: 4},
  ...
  planRowName: {fontSize: 13, fontWeight: '600', color: '#000'},
  ...
  upgradeBtnText: {fontSize: 11, fontWeight: '600', color: '#fff'},
  ...
  invoiceAmount: {fontSize: 14, fontWeight: '600', color: '#000'},
});
