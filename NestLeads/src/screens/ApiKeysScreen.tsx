...
const styles = StyleSheet.create({
  ...
  cardInfo: {flex: 1},
  keyName: {fontSize: 14, fontWeight: '600', color: '#000'},
  ...
  fieldLabel: {fontSize: 10, fontWeight: '600', color: '#64748b', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 4},
