...
const styles = StyleSheet.create({
  ...
  cardInfo: {flex: 1},
  docNumber: {fontSize: 14, fontWeight: '600', color: '#000'},
  ...
  totalsLabelBold: {fontSize: 13, fontWeight: '600', color: '#000'},
  totalsValueBold: {fontSize: 13, fontWeight: '600', color: '#000'},
