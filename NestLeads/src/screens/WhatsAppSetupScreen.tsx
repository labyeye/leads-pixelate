...
const styles = StyleSheet.create({
  ...
  statusTitle: {fontSize: 14, fontWeight: '600', color: '#000'},
  statusSub: {fontSize: 11, color: '#64748b', marginTop: 2},
  sectionTitle: {fontSize: 13, fontWeight: '600', color: '#000', marginBottom: 8, marginTop: 4},
  ...
  templateName: {flex: 1, fontSize: 13, fontWeight: '600', color: '#000'},
