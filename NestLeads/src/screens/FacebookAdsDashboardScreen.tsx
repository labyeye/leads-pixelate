...
const styles = StyleSheet.create({
  ...
  errorTitle: {fontSize: 14, fontWeight: '600', color: '#000'},
  ...
  errorBtnText: {fontSize: 12, fontWeight: '600', color: '#000'},
  kpiGrid: {flexDirection: 'row', flexWrap: 'wrap', gap: 10},
  kpiCard: {flexBasis: '47%', flexGrow: 1, borderWidth: 2, borderColor: '#000', padding: 14, ...NB_SHADOW},
  kpiValue: {fontSize: 18, fontWeight: '600', color: '#000'},
  ...
  sectionTitle: {fontSize: 11, fontWeight: '600', color: '#000', marginBottom: 12, letterSpacing: 0.5},
  ...
  legendValue: {fontSize: 11, fontWeight: '600', color: '#000'},
