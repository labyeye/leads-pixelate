...
const styles = StyleSheet.create({
  ...
  cardInfo: {flex: 1},
  clientName: {fontSize: 14, fontWeight: '600', color: '#000'},
  ...
  modalTitle: {fontSize: 12, fontWeight: '600', color: '#64748b', letterSpacing: 1},
  ...
  fieldLabel: {fontSize: 10, fontWeight: '600', color: '#64748b', textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 5},
