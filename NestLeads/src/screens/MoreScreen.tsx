...
const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    label: 'WhatsApp Logs',
    sub: 'Campaign delivery & read status',
    screen: 'WhatsAppLogs',
    color: '#25D366',
  },
  {
    ...
    sub: 'Connection status & templates',
  ...
  },
  {
    icon: 'briefcase-outline',
    label: 'Services',
    sub: 'Service allocations & delivery',
    screen: 'Services',
    color: '#22c55e',
  },
  {
    ...
    label: 'Price Books',
    sub: 'Wholesale & special-client prices',
    screen: 'PriceBooks',
    color: SECONDARY,
  },
  {
    icon: 'cart-outline',
    label: 'Sales Orders',
    sub: 'Orders confirmed with a client',
    screen: 'SalesOrders',
    color: PRIMARY,
  },
  {
    ...
    sub: 'What you order from suppliers',
  ...
  },
  {
    icon: 'key-outline',
    label: 'API Keys',
    sub: 'Generate keys for website forms',
    screen: 'ApiKeys',
    color: PRIMARY,
  },
  {
    ...
    label: 'Support',
    sub: 'Raise & track support tickets',
    screen: 'Support',
    color: SECONDARY,
  },
  {
