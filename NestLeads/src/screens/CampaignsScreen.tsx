...
const styles = StyleSheet.create({
  ...
  summaryChipCount: {fontSize: 13, fontWeight: '600'},
  summaryChipLabel: {fontSize: 7, fontWeight: '600', textTransform: 'uppercase'},
  ...
  cardTitle: {flex: 1},
  campaignName: {fontSize: 14, fontWeight: '600', color: '#000'},
  ...
  statLabel: {fontSize: 7, fontWeight: '600', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 1},
  ...
  actionBtnText: {fontSize: 11, fontWeight: '600', color: '#000'},
